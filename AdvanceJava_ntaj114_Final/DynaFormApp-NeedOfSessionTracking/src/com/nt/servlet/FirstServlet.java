...
public class FirstServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		 ...
		 //assign not selected state for checkbox
		  if(ms==null)
			  ms="single";
		  //Generate form2 based on the marital status.
		  if(ms.equalsIgnoreCase("married")){
			  pw.println("<h1 style='color:red;text-align:center'>Enter Marriage Life details </h1>");
			  ...
			  pw.println("<h1 style='color:red;text-align:center'>Enter Luxury Life details </h1>");
			  pw.println("<form action='surl' method='post'>");
